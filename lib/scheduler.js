...
const { GuildScheduledEventEntityType, GuildScheduledEventPrivacyLevel, GuildScheduledEventRecurrenceRuleFrequency, MessageFlags } = require('discord.js');
...
async function buildEventReminderMessage(guild, item) {
    ...
    // Format time until event. remindBeforeMs is required at creation, but an
    // item written before that was enforced would render "starts in NaNs" —
    // say something true instead of something broken.
